...
- Designed and created a full linux system management lab
- Built structured directories for reports, backups, logging, and user data
- Added multiple users and assigned groups following security best practices
- Applied correct permissions and ownership across all directories
- Developed a functional system wide backup solution
